...
describe('SignupPageComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: RegisterUserUseCaseService, useValue: { execute: jest.fn() } }
      ]
    })
    .compileComponents();
    ...
    registerUseCase = TestBed.inject(RegisterUserUseCaseService);
  ...
  describe('when user interact with "confirm password" field', () => {
    it('should display error message when field do not have same value as password field', () => {
      ...
      expect(errorMessage).toContain('Passwords does not match');
    });
  });
